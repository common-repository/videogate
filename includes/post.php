...
class VIDEOGATE_Post {
	...
	public function title() {
		...
		$is_map = apply_filters('videogate_post_title', $title, $this);
	...
	public function getExcerptFromContent($words_length = 35) {
		...
		$the_excerpt = apply_filters('videogate_get_excerpt_from_content', $the_excerpt, $words_length, $this);
	...
	public function increaseClicksStats() {
		...
		do_action('videogate_increase_click_stats', $this);
	}
}
